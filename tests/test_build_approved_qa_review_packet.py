...
def test_packet_is_deterministic_and_preserves_governance_inputs(tmp_path):
    source=tmp_path/SOURCE_PATH; source.parent.mkdir(parents=True); shutil.copy2(FIXTURES/"040219e-biscfaq.jsonl",source)
    decision=FIXTURES/'040219e-biscfaq.decisions.jsonl'; before=decision.read_bytes()
